...
#define MAVLINK_MSG_ID_THERMOPILE_ATTITUDE 194
...
typedef struct __mavlink_thermopile_attitude_t
{
 ...
 float pitch; ///< Euler angle pitch from thermopile sensors in radians. Positive for pitch up
} mavlink_thermopile_attitude_t;

#define MAVLINK_MSG_ID_THERMOPILE_ATTITUDE_LEN 12
#define MAVLINK_MSG_ID_194_LEN 12

#define MAVLINK_MSG_ID_THERMOPILE_ATTITUDE_CRC 60
#define MAVLINK_MSG_ID_194_CRC 60
 ...
 * @param pitch Euler angle pitch from thermopile sensors in radians. Positive for pitch up
...
/**
 * @brief Encode a thermopile_attitude struct
 *
 * @param system_id ID of this system
 * @param component_id ID of this component (e.g. 200 for IMU)
 * @param msg The MAVLink message to compress the data into
...
/**
 * @brief Encode a thermopile_attitude struct on a channel
 *
 * @param system_id ID of this system
 * @param component_id ID of this component (e.g. 200 for IMU)
 * @param chan The MAVLink channel this message will be sent over
 ...
 * @param thermopile_attitude C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_thermopile_attitude_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const mavlink_thermopile_attitude_t* thermopile_attitude)
{
	return mavlink_msg_thermopile_attitude_pack_chan(system_id, component_id, chan, msg, thermopile_attitude->time_boot_ms, thermopile_attitude->roll, thermopile_attitude->pitch);
}
...
#if MAVLINK_MSG_ID_THERMOPILE_ATTITUDE_LEN <= MAVLINK_MAX_PAYLOAD_LEN
/*
 ...
 */
static inline void mavlink_msg_thermopile_attitude_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint32_t time_boot_ms, float roll, float pitch)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
#endif
#else
	mavlink_thermopile_attitude_t *packet = (mavlink_thermopile_attitude_t *)msgbuf;
	packet->time_boot_ms = time_boot_ms;
	packet->roll = roll;
	packet->pitch = pitch;
 ...
 *
 * @return Euler angle pitch from thermopile sensors in radians. Positive for pitch up
 */
