...
typedef enum MAV_CMD
{
	...
	MAV_CMD_DO_THERMO_GYRO_SWITCH=209, /* Our switch to change between gyro control and thermo control |Switch? (0=gyro, 1=thermo)| Empty| Empty| Empty| Empty| Empty| Empty|  */
...
#include "./mavlink_msg_thermo_gyro_switch.h"
