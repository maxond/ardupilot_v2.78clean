...
const AP_Param::Info var_info[] PROGMEM = {
    ...
    // @Param: THERMO_PIN_X
    // @DisplayName: Thermo Sensor Pin X
    // @Description: Setting this to 0 ~ 13 will enable Thermo Pin1 Sensor on pins A0 ~ A13.
    // @Values: -1:Disabled, 0:A0, 1:A1, 13:A13
    // @User: Standard
    GSCALAR(thermo_pin_x,    "THERMO_PIN_X",    THERMO_PIN_X),
    
    // @Param: THERMO_PIN_Y
    // @DisplayName: Thermo Sensor Pin Y
    // @Description: Setting this to 0 ~ 13 will enable Thermo Pin2 Sensor on pins A0 ~ A13.
    // @Values: -1:Disabled, 0:A0, 1:A1, 13:A13
    // @User: Standard
    GSCALAR(thermo_pin_y,    "THERMO_PIN_Y",    THERMO_PIN_Y),
    
    // @Param: THERMO_PIN_Z
    // @DisplayName: Thermo Sensor Pin Z
    // @Description: Setting this to 0 ~ 13 will enable Thermo Pin3 Sensor on pins A0 ~ A13.
    // @Values: -1:Disabled, 0:A0, 1:A1, 13:A13
    // @User: Standard
    GSCALAR(thermo_pin_z,    "THERMO_PIN_Z",    THERMO_PIN_Z), 
